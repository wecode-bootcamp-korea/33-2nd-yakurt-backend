...
class KaKaoClient:
    def __init__(self, kakao_client_id):
        self.kakao_code_api = 'https://kauth.kakao.com/oauth/authorize?response_type=code'
    ...
    def get_auth_code(self, redirect_uri):
        return f'{self.kakao_code_api}&client_id={self.client_id }&redirect_uri={redirect_uri}'
...
class KakaoSignInView(View):
    def get(self, request):
        ...
        redirect_url = kakao_clinet.get_auth_code(KAKAO_REDIRECT_URI)
